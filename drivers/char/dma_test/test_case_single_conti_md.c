...
/**
 * __CB_qd_sgct_mode - queue done callback for case DTC_SINGLE_CONT_MODE
 *
...
/**
 * __CB_fd_sgct_mode - dma full done callback for __dtc_sgct_mode
 *
...
/**
 * __CB_hd_sgct_mode - dma half done callback for __dtc_sgct_mode
 *
 * Returns 0 if success, the err line number if failed.
 */
...
/**
 * __CB_op_sgct_mode - dma op callback for __dtc_sgct_mode
 *
 * Returns 0 if success, the err line number if failed.
 */
...
/**
 * __Waitdone_sgct_mode - wait dma done for DTC_SINGLE_CONT_MODE
 *
 * Returns 0 if success, the err line number if failed.
 */
