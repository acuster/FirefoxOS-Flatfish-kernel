 ...
 *
 * History
 * 2012-6-8 13:34:42, modified by yemao, for aw1633
 */
#ifndef HOST_PLAT_H
#define HOST_PLAT_H
...
/* interrupt number */
#ifndef MMC_FPGA
#define  INTC_IRQNO_SMC0       92
#define  INTC_IRQNO_SMC1       93
#define  INTC_IRQNO_SMC2       94
#define  INTC_IRQNO_SMC3       95
#else
#define  INTC_IRQNO_SMC0       45
#define  INTC_IRQNO_SMC1       45
#define  INTC_IRQNO_SMC2       45
#define  INTC_IRQNO_SMC3       45
#endif
...
/*                              aw1623 platform                                */
/*=============================================================================*/
#if defined CONFIG_CHIP_ID && (CONFIG_CHIP_ID==1123)
...
/*                              aw1625 platform                                */
/*=============================================================================*/
#if defined CONFIG_CHIP_ID && (CONFIG_CHIP_ID==1125)
