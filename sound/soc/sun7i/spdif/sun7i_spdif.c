...
static struct sun7i_dma_params sun7i_spdif_stereo_in = {
	.client		=	&sun7i_dma_client_in,
	.channel	=	DMACH_NSPDIF,
	.dma_addr 	=	SUN7I_SPDIFBASE + SUN7I_SPDIF_RXFIFO,
	.dma_size 	=   4,               /* dma transfer 32bits */
};
																...
																struct snd_soc_dai *dai)
{
	...
	if(substream->stream == SNDRV_PCM_STREAM_PLAYBACK)
		...
		dma_data = &sun7i_spdif_stereo_in;
