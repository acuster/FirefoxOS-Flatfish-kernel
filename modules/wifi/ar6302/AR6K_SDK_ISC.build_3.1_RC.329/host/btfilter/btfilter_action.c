    ...
    switch (tag) {
        case BT_STATUS_TAG:
           /* set up item and struct pointer */
            ...
            pCore->FilterState.btFilterFlags |= ABF_WIFI_CHIP_IS_VENUS;
        ...
        case BT_PARAM_SCO_TAG:
                ...
                if(pCore->FilterState.btFilterFlags & ABF_WIFI_CHIP_IS_VENUS) {
                    ...
                    BTCOEX_SCO_CONFIG * pScoGenericConfig = (BTCOEX_SCO_CONFIG*)&pScoConfigCmd->scoConfig;
                    BTCOEX_PSPOLLMODE_SCO_CONFIG* pScoPspollConfig = (BTCOEX_PSPOLLMODE_SCO_CONFIG*) &pScoConfigCmd->scoPspollConfig;
                    BTCOEX_OPTMODE_SCO_CONFIG  * pScoOptModeConfig = (BTCOEX_OPTMODE_SCO_CONFIG*) &pScoConfigCmd->scoOptModeConfig;
                    BTCOEX_WLANSCAN_SCO_CONFIG * pScoWlanScanConfig = (BTCOEX_WLANSCAN_SCO_CONFIG*) &pScoConfigCmd->scoWlanScanConfig;
        ...
        case BT_PARAM_A2DP_TAG:
                ...
                if(pCore->FilterState.btFilterFlags & ABF_WIFI_CHIP_IS_VENUS) {
                    ...
                    BTCOEX_A2DP_CONFIG * pA2dpGenericConfig = (BTCOEX_A2DP_CONFIG*) &pA2dpConfigCmd->a2dpConfig;
                    BTCOEX_PSPOLLMODE_A2DP_CONFIG* pA2dpPspollConfig = (BTCOEX_PSPOLLMODE_A2DP_CONFIG*) &pA2dpConfigCmd->a2dppspollConfig;
                    BTCOEX_OPTMODE_A2DP_CONFIG  * pA2dpOptModeConfig = (BTCOEX_OPTMODE_A2DP_CONFIG*) &pA2dpConfigCmd->a2dpOptConfig;
