...
#define SUN7I_SPI_ADDR_SIZE		0xFFF
#define SPI0_BASE_ADDR_START	(0x01C68000)
#define SPI0_BASE_ADDR_END		(SPI0_BASE_ADDR_START + SUN7I_SPI_ADDR_SIZE)
#define SPI1_BASE_ADDR_START	(0x01C69000)
#define SPI1_BASE_ADDR_END		(SPI1_BASE_ADDR_START + SUN7I_SPI_ADDR_SIZE)
#define SPI2_BASE_ADDR_START	(0x01C6A000)
#define SPI2_BASE_ADDR_END		(SPI2_BASE_ADDR_START + SUN7I_SPI_ADDR_SIZE)
#define SPI3_BASE_ADDR_START	(0x01C6B000)
#define SPI3_BASE_ADDR_END		(SPI3_BASE_ADDR_START + SUN7I_SPI_ADDR_SIZE)

#define SUN7I_IRQ_SPI0	45
